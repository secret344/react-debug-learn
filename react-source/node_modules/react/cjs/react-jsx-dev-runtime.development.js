...
function defineKeyPropWarningGetter(props, displayName) {
  {
    var warnAboutAccessingKey = function () {
      // 显示特殊道具关键警告 specialPropKeyWarningShown默认未定义
    ...
    // 获取props的key时 执行warnAboutAccessingKey 首次执行会触发警告
 ...
 * 给定一个元素，验证其道具是否遵循类型所提供的propTypes定义。
...
function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
  {
    // 在这种情况下，我们警告但不要扔。我们希望元素创建成功，但在渲染中可能会出现错误。
    // 判断是不是一个有效jsx 是有效的元素类型
